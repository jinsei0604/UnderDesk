...
- **掘削アニメ（2026-07-12更新）**: minion_0 は5コマ（idle + 振りかぶり×2 + 着地/砂煙×2、tools/extract_sprites.gd の "miner_v2" プリセット、原本 assets/reference/miner_sheet_v2.png）。ベースのidle絵（minion_0.png）は元の素材のまま維持——新シートの該当セルは隣接ポーズが常ににじみ込み、自動グリッド抽出では綺麗に切り出せなかったため
