...
func _build_ui() -> void:
	...
	restart_confirm_label.text = "最初からやり直しますか？"
...
func refresh() -> void:
	...
	if battle.battle_over:
		...
		_outcome_label.text = "クリア！" if won else "敗北"
