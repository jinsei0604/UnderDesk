...
## UNDERDESK / Eos Burst v22 reference implementation.
##
## This revision keeps the approved cut-in, slash, impact and outer art
## byte-identical. It replaces the body-sized aura and uses a dark-cleaned copy
## of the same Sotiris pixels. Adapt node paths, but keep these contracts:
...
##   foot anchor is reused for all twelve motion cells;
...
const CUTIN_TEXTURE := preload("res://assets/vfx/eos_burst/v22/assets/eos_cutin_sword_closeup.png")
const SOTIRIS_MOTION_TEXTURE := preload("res://assets/vfx/eos_burst/v22/assets/sotiris_eos_downslash_12f_crisp_v21.png")
const DITHER_SHADER := preload("res://assets/vfx/eos_burst/v22/godot/sprite_dither_v22.gdshader")

const SWORD_AURA_TEXTURES: Array[Texture2D] = [
	preload("res://assets/vfx/eos_burst/v22/frames/sword_blade_aura_v21/aura_00.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/sword_blade_aura_v21/aura_01.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/sword_blade_aura_v21/aura_02.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/sword_blade_aura_v21/aura_03.png"),
]

const MAIN_TEXTURES: Array[Texture2D] = [
	preload("res://assets/vfx/eos_burst/v22/frames/grand_crescent_v12_tip_locked/grand_00.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/grand_crescent_v12_tip_locked/grand_01.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/grand_crescent_v12_tip_locked/grand_02.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/grand_crescent_v12_tip_locked/grand_03.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/grand_crescent_v12_tip_locked/grand_04.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/grand_crescent_v12_tip_locked/grand_05.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/grand_crescent_v12_tip_locked/grand_07.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/grand_crescent_v12_tip_locked/grand_08.png"),
]

const IMPACT_TEXTURES: Array[Texture2D] = [
	preload("res://assets/vfx/eos_burst/v22/frames/enemy_crossflash_v8/crossflash_00.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/enemy_crossflash_v8/crossflash_01.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/enemy_crossflash_v8/crossflash_02.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/enemy_crossflash_v8/crossflash_03.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/enemy_crossflash_v8/crossflash_04.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/enemy_crossflash_v8/crossflash_05.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/enemy_crossflash_v8/crossflash_06.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/enemy_crossflash_v8/crossflash_07.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/enemy_crossflash_v8/crossflash_08.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/enemy_crossflash_v8/crossflash_09.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/enemy_crossflash_v8/crossflash_10.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/enemy_crossflash_v8/crossflash_11.png"),
]

## outer_08 is intentionally absent: it is the unwanted pale circular tail.
const OUTER_TEXTURES: Array[Texture2D] = [
	preload("res://assets/vfx/eos_burst/v22/frames/burst_outer_v15_no_white_disc/outer_00.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/burst_outer_v15_no_white_disc/outer_01.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/burst_outer_v15_no_white_disc/outer_02.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/burst_outer_v15_no_white_disc/outer_03.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/burst_outer_v15_no_white_disc/outer_04.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/burst_outer_v15_no_white_disc/outer_05.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/burst_outer_v15_no_white_disc/outer_06.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/burst_outer_v15_no_white_disc/outer_07.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/burst_outer_v15_no_white_disc/outer_09.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/burst_outer_v15_no_white_disc/outer_10.png"),
	preload("res://assets/vfx/eos_burst/v22/frames/burst_outer_v15_no_white_disc/outer_11.png"),
]

## v22 keeps the accepted finish intact and lengthens only anticipation. The
## release now takes2.96s instead of v21's1.80s. The final0.080s of each
## interval uses a binary4x4 dither reveal, never two
## translucent whole-character silhouettes.
const CHARACTER_FRAME_TIMES := [
	0.380, 0.360, 0.360, 0.380, 0.460, 0.600,
	0.420, 0.180, 0.160, 0.160, 0.200, 0.240,
]
const CHARACTER_DITHER_MAX := 0.080
const RELEASE_FRAME_INDEX := 7
const CHARACTER_RELEASE_TIME := 2.960
...
const SWORD_AURA_STAGE_TIMES := [0.450, 0.550, 0.700, 1.190]
...
const CUTIN_TO_RELEASE_VISIBLE_BRIDGE := 1.110
...
## v22 preserves v21's accepted contact draw and flash exactly.
...
func play_crisp_character_with_sword_aura(
	...
	assert(CHARACTER_FRAME_TIMES.size() == 12)
	assert(SWORD_SEGMENTS.size() == 12)
	assert(is_equal_approx(_sum_times(CHARACTER_FRAME_TIMES), 3.900))
	var release_sum := 0.0
	...
	for frame_index in range(12):
		...
		var next_frame := mini(frame_index + 1, 11)
		...
		while true:
			...
			var frame_mix := 0.0
			if frame_index < 11 and local_time >= interval - CHARACTER_DITHER_MAX:
				frame_mix = _smootherstep(
					(local_time - (interval - CHARACTER_DITHER_MAX)) / CHARACTER_DITHER_MAX
				)
...
func play_continuous_finish_chain(
	...
	print(
		"EOS_V22_CONTINUITY release_draw=", _release_draw_frame,
...
func play_v22_eos_burst(
	...
	## Cut-in has already disappeared1.11s before release. The viewer sees the
	## complete charged apex hold and frame6->7 transition before the slash.
