...
## UNDERDESK / Eos Burst v26 reference implementation.
##
## This revision keeps the approved cut-in, slash, impact and outer art
## byte-identical. Frames6..10 reproduce the reference video's loaded apex,
## maximum backswing, descending blade path and ground contact while locking
## current Sotiris's chibi proportions, palette, one runtime scale and anchor.
...
const CUTIN_TEXTURE := preload("res://assets/vfx/eos_burst/v26/assets/eos_cutin_sword_closeup.png")
const SOTIRIS_MOTION_TEXTURE := preload("res://assets/vfx/eos_burst/v26/assets/sotiris_eos_downslash_17f_reference_motion_v26.png")
const DITHER_SHADER := preload("res://assets/vfx/eos_burst/v26/godot/sprite_dither_v26.gdshader")

const SWORD_AURA_TEXTURES: Array[Texture2D] = [
	preload("res://assets/vfx/eos_burst/v26/frames/sword_blade_aura_v21/aura_00.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/sword_blade_aura_v21/aura_01.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/sword_blade_aura_v21/aura_02.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/sword_blade_aura_v21/aura_03.png"),
]

const MAIN_TEXTURES: Array[Texture2D] = [
	preload("res://assets/vfx/eos_burst/v26/frames/grand_crescent_v12_tip_locked/grand_00.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/grand_crescent_v12_tip_locked/grand_01.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/grand_crescent_v12_tip_locked/grand_02.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/grand_crescent_v12_tip_locked/grand_03.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/grand_crescent_v12_tip_locked/grand_04.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/grand_crescent_v12_tip_locked/grand_05.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/grand_crescent_v12_tip_locked/grand_07.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/grand_crescent_v12_tip_locked/grand_08.png"),
]

const IMPACT_TEXTURES: Array[Texture2D] = [
	preload("res://assets/vfx/eos_burst/v26/frames/enemy_crossflash_v8/crossflash_00.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/enemy_crossflash_v8/crossflash_01.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/enemy_crossflash_v8/crossflash_02.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/enemy_crossflash_v8/crossflash_03.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/enemy_crossflash_v8/crossflash_04.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/enemy_crossflash_v8/crossflash_05.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/enemy_crossflash_v8/crossflash_06.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/enemy_crossflash_v8/crossflash_07.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/enemy_crossflash_v8/crossflash_08.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/enemy_crossflash_v8/crossflash_09.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/enemy_crossflash_v8/crossflash_10.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/enemy_crossflash_v8/crossflash_11.png"),
]

## outer_08 is intentionally absent: it is the unwanted pale circular tail.
const OUTER_TEXTURES: Array[Texture2D] = [
	preload("res://assets/vfx/eos_burst/v26/frames/burst_outer_v15_no_white_disc/outer_00.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/burst_outer_v15_no_white_disc/outer_01.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/burst_outer_v15_no_white_disc/outer_02.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/burst_outer_v15_no_white_disc/outer_03.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/burst_outer_v15_no_white_disc/outer_04.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/burst_outer_v15_no_white_disc/outer_05.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/burst_outer_v15_no_white_disc/outer_06.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/burst_outer_v15_no_white_disc/outer_07.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/burst_outer_v15_no_white_disc/outer_09.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/burst_outer_v15_no_white_disc/outer_10.png"),
	preload("res://assets/vfx/eos_burst/v26/frames/burst_outer_v15_no_white_disc/outer_11.png"),
]

## v26 preserves v25's readable charge and accepted finish, but replaces the
## four-pose cut with five reference-video poses.  Together with the inherited
## low follow-through, the visible swing occupies 0.740s. Short intervals
...
const SWORD_SEGMENTS: Array[Vector4] = [
	...
	Vector4(110,128,110,69), Vector4(98,136,49,128),
	Vector4(113,166,120,212), Vector4(111,171,144,208),
	Vector4(112,177,153,211),
...
const CUTIN_TO_RELEASE_VISIBLE_BRIDGE := 1.430
...
## v26 preserves v21's accepted contact draw and flash exactly.
...
func play_crisp_character_with_sword_aura(
	...
	## The backswing is authored at 189 degrees in screen coordinates.  The
	## attack then descends strictly clockwise: 189 -> 81 -> 48 -> 40.
	var previous_attack_angle := INF
	for swing_index in range(7, 11):
		var segment := SWORD_SEGMENTS[swing_index]
		var swing_angle := Vector2(segment.z - segment.x, segment.w - segment.y).angle()
		if swing_angle < 0.0:
			swing_angle += TAU
		assert(swing_angle < previous_attack_angle)
		previous_attack_angle = swing_angle
...
func play_continuous_finish_chain(
	...
	print(
		"EOS_V26_CONTINUITY release_draw=", _release_draw_frame,
...
func play_v26_eos_burst(
	...
	## Cut-in has already disappeared 1.43s before release. The viewer sees the
	## charged apex plus all five new motion poses before the slash.
