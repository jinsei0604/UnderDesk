...
## UNDERDESK / Eos Burst v25 reference implementation.
##
## This revision keeps the approved cut-in, slash, impact and outer art
## byte-identical. Frames6..9 preserve the authentic two-handed overhead cut
## while locking current Sotiris's chibi proportions, palette, 1px density,
## one runtime scale and one foot anchor.
## Adapt node paths, but keep these contracts:
## - character, sword aura, cut-in, slash, impact and burst are process-frame driven;
## - no phase waits for the preceding visual to disappear before it may begin;
## - the cut-in panel transform is completely fixed while the character and
##   aura continue underneath it;
...
##   foot anchor is reused for all sixteen motion cells;
...
const CUTIN_TEXTURE := preload("res://assets/vfx/eos_burst/v25/assets/eos_cutin_sword_closeup.png")
const SOTIRIS_MOTION_TEXTURE := preload("res://assets/vfx/eos_burst/v25/assets/sotiris_eos_downslash_16f_current_scale_v25.png")
const DITHER_SHADER := preload("res://assets/vfx/eos_burst/v25/godot/sprite_dither_v25.gdshader")

const SWORD_AURA_TEXTURES: Array[Texture2D] = [
	preload("res://assets/vfx/eos_burst/v25/frames/sword_blade_aura_v21/aura_00.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/sword_blade_aura_v21/aura_01.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/sword_blade_aura_v21/aura_02.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/sword_blade_aura_v21/aura_03.png"),
]

const MAIN_TEXTURES: Array[Texture2D] = [
	preload("res://assets/vfx/eos_burst/v25/frames/grand_crescent_v12_tip_locked/grand_00.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/grand_crescent_v12_tip_locked/grand_01.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/grand_crescent_v12_tip_locked/grand_02.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/grand_crescent_v12_tip_locked/grand_03.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/grand_crescent_v12_tip_locked/grand_04.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/grand_crescent_v12_tip_locked/grand_05.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/grand_crescent_v12_tip_locked/grand_07.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/grand_crescent_v12_tip_locked/grand_08.png"),
]

const IMPACT_TEXTURES: Array[Texture2D] = [
	preload("res://assets/vfx/eos_burst/v25/frames/enemy_crossflash_v8/crossflash_00.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/enemy_crossflash_v8/crossflash_01.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/enemy_crossflash_v8/crossflash_02.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/enemy_crossflash_v8/crossflash_03.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/enemy_crossflash_v8/crossflash_04.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/enemy_crossflash_v8/crossflash_05.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/enemy_crossflash_v8/crossflash_06.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/enemy_crossflash_v8/crossflash_07.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/enemy_crossflash_v8/crossflash_08.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/enemy_crossflash_v8/crossflash_09.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/enemy_crossflash_v8/crossflash_10.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/enemy_crossflash_v8/crossflash_11.png"),
]

## outer_08 is intentionally absent: it is the unwanted pale circular tail.
const OUTER_TEXTURES: Array[Texture2D] = [
	preload("res://assets/vfx/eos_burst/v25/frames/burst_outer_v15_no_white_disc/outer_00.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/burst_outer_v15_no_white_disc/outer_01.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/burst_outer_v15_no_white_disc/outer_02.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/burst_outer_v15_no_white_disc/outer_03.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/burst_outer_v15_no_white_disc/outer_04.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/burst_outer_v15_no_white_disc/outer_05.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/burst_outer_v15_no_white_disc/outer_06.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/burst_outer_v15_no_white_disc/outer_07.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/burst_outer_v15_no_white_disc/outer_09.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/burst_outer_v15_no_white_disc/outer_10.png"),
	preload("res://assets/vfx/eos_burst/v25/frames/burst_outer_v15_no_white_disc/outer_11.png"),
]

## v25 preserves v24's readable timing and body-led overhead-cut arc, but
## rebuilds all four in-betweens from a current-Sotiris integer-3x edit master.
## The complete swing
## from pose5 to inherited pose6 occupies0.540s. Short in-between intervals
## dither for at most45 percent of their duration; longer holds retain the
## existing0.080s cap.
...
const RELEASE_FRAME_INDEX := 11
const CHARACTER_RELEASE_TIME := 3.080
...
const SWORD_SEGMENTS: Array[Vector4] = [
	...
	Vector4(105,167,137,70), Vector4(97,135,166,85),
	Vector4(105,161,182,196), Vector4(116,162,165,212),
...
const SWORD_AURA_STAGE_TIMES := [0.450, 0.550, 0.700, 1.310]
...
## The diagonal cut-in panel is now completely stationary. Only its alpha is
## animated. Character frames1..5 and the aura continue underneath it.
const CUTIN_START_AFTER_CHARACTER := 0.800
const CUTIN_DURATION := 1.050
const CUTIN_ENTER_DURATION := 0.140
const CUTIN_EXIT_DURATION := 0.180
const CUTIN_TO_RELEASE_VISIBLE_BRIDGE := 1.230
...
## v25 preserves v21's accepted contact draw and flash exactly.
...
func _configure_motion_sprite(
	...
	sprite.z_index = int(original["z_index"])
...
func play_crisp_character_with_sword_aura(
	...
	assert(CHARACTER_FRAME_TIMES.size() == 16)
	assert(SWORD_SEGMENTS.size() == 16)
	var previous_swing_angle := -PI
	for swing_index in range(6, 10):
		var segment := SWORD_SEGMENTS[swing_index]
		var swing_angle := Vector2(segment.z - segment.x, segment.w - segment.y).angle()
		assert(swing_angle > previous_swing_angle)
		previous_swing_angle = swing_angle
	assert(SWORD_SEGMENTS[8].w - SWORD_SEGMENTS[8].y >= 20.0)
	assert(SWORD_SEGMENTS[9].w - SWORD_SEGMENTS[9].y >= 40.0)
	assert(is_equal_approx(_sum_times(CHARACTER_FRAME_TIMES), 4.020))
	var release_sum := 0.0
	...
	for frame_index in range(16):
		...
		var next_frame := mini(frame_index + 1, 15)
		...
		while true:
			...
			if frame_index < 15 and local_time >= interval - dither_duration:
...
func play_fixed_cutin(cutin_root: Node2D) -> void:
	## cutin_root must be the existing diagonal clipped panel that already owns
	## eos_cutin_sword_closeup.png and lives under a screen-space CanvasLayer.
	## The panel is fixed; only alpha changes.
	## Never pause AnimationTree, SceneTree, character playback or Engine time.
	var base_position := cutin_root.position
	var base_scale := cutin_root.scale
	var base_rotation := cutin_root.rotation
	var base_skew := cutin_root.skew
	var frozen_global_transform := cutin_root.global_transform
	cutin_root.visible = true
	_set_alpha(cutin_root, 0.0)
	var start_usec := Time.get_ticks_usec()
	while true:
		var elapsed := float(Time.get_ticks_usec() - start_usec) / 1000000.0
		if elapsed >= CUTIN_DURATION:
			break
		## Freeze the complete screen-space transform on every draw. The cut-in
		## image and diagonal frame must not drift, slide, scale, rotate, follow
		## MotionAnchor, or inherit a world/camera Tween.
		cutin_root.global_transform = frozen_global_transform
		var alpha := 1.0
		if elapsed < CUTIN_ENTER_DURATION:
			alpha = _smootherstep(elapsed / CUTIN_ENTER_DURATION)
		elif elapsed > CUTIN_DURATION - CUTIN_EXIT_DURATION:
			alpha = 1.0 - _smootherstep(
				(elapsed - (CUTIN_DURATION - CUTIN_EXIT_DURATION)) / CUTIN_EXIT_DURATION
			)
		_set_alpha(cutin_root, alpha)
		await get_tree().process_frame
	## Restore the exact local values after the screen-space lock is released.
	cutin_root.position = base_position
	cutin_root.scale = base_scale
	cutin_root.rotation = base_rotation
	cutin_root.skew = base_skew
...
func play_continuous_finish_chain(
	...
	print(
		"EOS_V25_CONTINUITY release_draw=", _release_draw_frame,
...
func play_v25_eos_burst(
	...
	## Deliberately no await: the pose clock and blade aura continue under cut-in.
	play_crisp_character_with_sword_aura(
		original_sotiris, motion_a, motion_b,
		sword_aura_root, aura_a, aura_b
	)
	await get_tree().create_timer(CUTIN_START_AFTER_CHARACTER).timeout
	## Deliberately no await: fixed cut-in alpha cannot stop underlying motion.
	play_fixed_cutin(cutin_root)
	assert(is_equal_approx(
		CHARACTER_RELEASE_TIME - (CUTIN_START_AFTER_CHARACTER + CUTIN_DURATION),
		CUTIN_TO_RELEASE_VISIBLE_BRIDGE
	))

	## Cut-in has already disappeared1.23s before release. The viewer sees the
	## charged apex plus all four new swing in-betweens before the slash.
